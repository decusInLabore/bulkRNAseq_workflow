...
geneID <- as.vector(dfTPM[1,1])
geneID <- gsub("[0-9.]", "", geneID)

names(dfTPM) <- gsub("gene_id", geneID, names(dfTPM))
...
pipelineList[["lab.categories.table"]] <- "es_lab_categories"
pipelineList[["project_name"]] <- "Colins New Project"
pipelineList[["project_id"]] <- "RN21261"
pipelineList[["labname"]] <- "Sahai"
pipelineList[["lims.id"]] <- "RN21261"
...
pipelineList[["primDataDB"]] <- "esl_data"
...
pipelineList[["ReferenceTableSelection	"]] <- ""
pipelineList[["referenceTableListDB"]] <- "Hallmark Signatures"
pipelineList[["referenceTableListDB"]] <- "Pathways"
pipelineList[["referenceTableListDB"]] <- "GO-BP"
pipelineList[["referenceTableListDB"]] <- "GO-MF"
pipelineList[["referenceTableListDB"]] <- "TF Motifs"
pipelineList[["referenceTableListDB"]] <- "Protein Complexes"
pipelineList[["referenceTableListDB"]] <- "Immunologic Signatures"
pipelineList[["referenceTableListDB"]] <- "LINCS Down"
pipelineList[["referenceTableListDB"]] <- "LINCS Up"
pipelineList[["referenceTableListDB"]] <- "Cell Type Signatures"
pipelineList[["referenceTableListDB"]] <- "Cell Type Signatures"
...
write.csv(dfObio, "design/bulk.design.file.csv", row.names=FALSE, header=FALSE)
