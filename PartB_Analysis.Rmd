...
# Existence of a design file including contrasts/LRTs
# Existence of a read-count matrix
# 

# do here
# Run DEseq2 contrast/LRT - create contrast LRT table (A) or (B) load from file

# B.1.DEse2.create.object
# B.2.DEseq2.normalization.and.PCA
#       - Obio@dfPCA <- dfPCA
# B.3.DEseq2.create.DGE.and.LRT.tables
#       - Obio@DEseq2contrastTable <- dfContrastTable
#       - Obio@dataTableList[["Ntop4pcaGeneSelection"]] <- rowSelVec
#       - 
# B.4.calculate pairwise correlation
# 
