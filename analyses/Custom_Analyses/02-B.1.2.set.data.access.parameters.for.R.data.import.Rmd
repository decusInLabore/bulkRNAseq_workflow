...
countDbTable <- paste0('countTB <- "', countDbTable,'"')
...
```{r, echo=TRUE, eval=F, warning=FALSE, class.source = 'fold-show', tidy=TRUE}
...
## Load count data
dfCount <- import.db.table.from.db(
  dbname = db,
  dbtable = countTB,
  host = host,
  user = username,
...
```{r, echo=F, eval=T, warning=FALSE,comment=NA, tidy=TRUE}
