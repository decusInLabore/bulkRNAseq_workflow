...
## Get available files
seqDir <-  c(
    "/nemo/stp/sequencing/outputs/babs/data/anastasioud/patricia.nunes/RN23138/primary_data/230718_A01366_0418_BHHGGWDSX7/fastq/"
)
...
biologicSeqTools2::createbulkRNASeqAnalysisNFcoreScript(
    outdir = workdir,
    genomeFa = "/nemo/svc/reference/Genomics/babs/mus_musculus/ensembl/GRCm38/release-95/genome/Mus_musculus.GRCm38.dna_sm.toplevel.fa",
    GTFfile = "/nemo/svc/reference/Genomics/babs/mus_musculus/ensembl/GRCm38/release-95/gtf/Mus_musculus.GRCm38.95.rnaseqc.gtf",
    project_id = "RN23138",
...
## Change cachedir to
# export NXF_SINGULARITY_CACHEDIR=//camp/apps/misc/stp/babs/nf-core/singularity/rnaseq/3.9/
...
## Create base design
dfTemp <- read.delim(
    "/nemo/stp/babs/working/boeings/Projects/anastasioud/patricia.nunes/551_bulkRNAseq_GyKKO_PyglKO_AlbCre_RN23138/data/metadata/base.design.txt",
    sep = "\t"
)


## create numeric timepoint column
dfTemp[["timepoint"]] <- dfTemp$f_Timepoint
dfTemp$timepoint <- gsub("Early", "1", dfTemp$timepoint)
dfTemp$timepoint <- gsub("Late", "2", dfTemp$timepoint)
dfTemp$timepoint <- as.numeric(dfTemp$timepoint)
