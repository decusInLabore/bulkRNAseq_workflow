...
pipelineList <- biologicSeqTools2::assembleBiologicProject(
  ...
  experiment_id = "GSE130017",
  project_name = "Analysis of the expression profile of skin fibroblasts FACS-sorted from mice overexpressing activin and or oncogenes of human papilloma virus 8 in keratinocytes.",
  lims.id = "GSE130017",
  labname = "Werner",
  NtopGenes = 500,
