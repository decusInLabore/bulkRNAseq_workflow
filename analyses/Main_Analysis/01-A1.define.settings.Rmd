...
pipelineList <- biologicSeqTools2::assembleBiologicProject(
  ...
  DEseq2External_DGE = "/camp/stp/babs/working/boeings/Projects/papayannopoulosv/tessa.swanton/529_rna_seq_visualization_RN22122/data/input_dge/",
  ...
  experiment_id = "RN22122",
  project_name = "Sepsis",
  lims.id = "RN22122",
  labname = "Papayannopoulos",
  NtopGenes = 1000,
  ...
  primDataDB = "papayannopoulos_data",
  db.user = "babs",
  host = "10.27.241.82",
  lab.categories.table = "Papayannopoulos_lab_categories",
  corGeneVec = NULL
)
