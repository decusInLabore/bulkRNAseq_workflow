...
modelFN <- "Y:/working/boeings/Projects/goulda/adrien.franchet/472A_brains_from_drosophila_larvae_RN21220/workdir/bulkRNAseq_workflow/design/RN21220test2.model.table.txt"
...
countTableFN = "Y:/working/boeings/Projects/goulda/adrien.franchet/472A_brains_from_drosophila_larvae_RN21220/data/RN21220test.count.data.txt"
...
if (sum(checkNames %in% designNames) != length(checkNames)){
    exit("Check if the sample.ids given in the Count file match those in the design file.")
} else {
    print("Count file ok. ")
}
...
dfCount <- unique(dfTPM[, countOrder])
