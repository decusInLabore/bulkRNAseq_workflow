...
## Get available files
seqDir <-  c(
    "/camp/stp/sequencing/outputs/babs/data/wacka/vasileios.samelis/RN22209/primary_data/220808_A01366_0254_AHTMGYDSX3/fastq/",
    "/camp/stp/sequencing/outputs/babs/data/wacka/vasileios.samelis/RN22209/primary_data/220818_A01366_0265_AHG7N3DMXY/fastq/",
    "/camp/stp/sequencing/outputs/babs/data/wacka/vasileios.samelis/RN22209/primary_data/220826_A01366_0271_AHF7H3DMXY/fastq/"
)
...
baseDesignFN <- paste0(projectDir, "data/base.design.txt")
...
## Reorder
dfDesign <- dfDesign[order(dfDesign$f_Status, dfDesign$f_Sex),]
...
# comparisonList = list(
#     "comp_1" = c("Disease", "Control"),
#     "comp_2" = c("Female_Disease", "Female_Control"),
#     "comp_3" = c("Male_Disease", "Male_Control")
# )
# 
...
dfDesign <- dfDesign[order(dfDesign$sample.id, decreasing = F),]
dfDesign <- dfDesign[order(dfDesign$LRT_WT_KO, decreasing = T),]
dfDesign <- dfDesign[order(dfDesign$LRT_Celltype, decreasing = T),]
...
betaPrior <- c(rep(TRUE, length(comparison)))
