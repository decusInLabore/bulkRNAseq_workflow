...
FN <- paste0(projectDir, "data/base.design.RN22179.txt")
...
## Get available files
seqDir <-  c(
    "/camp/stp/sequencing/outputs/babs/data/liv/sofia.pedersen/RN22179/primary_data/220801_A01366_0248_BHCHGTDMXY/fastq/",
    "/camp/stp/sequencing/outputs/babs/data/liv/sofia.pedersen/RN22179/primary_data/220811_A01366_0258_BHFFK2DMXY/fastq/"
)
...
baseDesignFN <- paste0(projectDir, "data/base.design.RN22179.txt")
...
dfDesign <- dfDesign[order(dfDesign$f_Status, dfDesign$f_Sex, dfDesign$f_Batch),]
...
model <- c("~ f_Batch + f_Sex + condition",rep("~ f_Batch + condition", length(comparison)-1))
...
betaPrior <- c(rep(FALSE, length(comparison)))
