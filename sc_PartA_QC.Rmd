...
<!--
- create design file with comparisons
- create model file for dges
- create alignment file
- create rsem file
- do deseq2
-->

<!-- Option B: Load pre-processed design, dfTPM, dfPCA, variation files -->
```{r child = 'src/modules/part_A/A.1B.load.input.files.Rmd', eval=TRUE}
```


<!-- At the end of the module the following ouptus are required 
- design file
- count/TPM file
- dfPCA
-->
