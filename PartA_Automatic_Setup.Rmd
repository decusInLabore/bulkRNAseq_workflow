...
pipelineList <- biologicSeqTools2::assembleBiologicProject(
    ...
    designFN =  "/camp/stp/babs/working/boeings/projects/boeings/stefan.boeing/dev_test/data/DESeq2_input_SB_edit/RN19316_design.new.txt",
    ## Path to model table ##
    ...
    countTableFN = "/camp/stp/babs/working/boeings/projects/boeings/stefan.boeing/dev_test/data/DESeq2_input_SB_edit/dfRSEMcounts.new.txt",
    ## Path to TPM table. 
    TpmTableFN =  "/camp/stp/babs/working/boeings/projects/boeings/stefan.boeing/dev_test/data/DESeq2_input_SB_edit/dfTPM.new.txt",
    PcaFN =  "//camp/stp/babs/working/boeings/projects/boeings/stefan.boeing/dev_test/data/DESeq2_input_SB_edit/dfPCA.new.txt", #"/camp/stp/babs/working/boeings/Projects/goulda/adrien.franchet/472A_brains_from_drosophila_larvae_RN21220/workdir/data/dfPca.txt",
    calculate_DGE = FALSE,
    calculate_LRT = FALSE,
