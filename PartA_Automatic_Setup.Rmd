...
pipelineList <- biologicSeqTools2::assembleBiologicProject(
    ...
    dfPcaFN = NULL, #"/camp/stp/babs/working/boeings/Projects/goulda/adrien.franchet/472A_brains_from_drosophila_larvae_RN21220/workdir/data/dfPca.txt",
    calculate_DGE = TRUE,
    calculate_LRT = TRUE,
    ## Path to external DEseq2 output files
    DEseq2External_DGE = NULL, #"/camp/stp/babs/working/boeings/Projects/goulda/adrien.franchet/472A_brains_from_drosophila_larvae_RN21220/workdir/data/DEseq2External_DGE/",
    DEseq2External_LRT = NULL, #"/camp/stp/babs/working/boeings/Projects/goulda/adrien.franchet/472A_brains_from_drosophila_larvae_RN21220/workdir/data/DEseq2External_LRT/",
    #stranded = TRUE,
    #read.length = "100bp",
    #paired.end = FALSE,
