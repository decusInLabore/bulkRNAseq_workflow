...
<!-- Optional: Setup alignment to create RSEM count table, TPM table -->
<!-- Required inputs: design table, model table, filepaths -->
```{r child = 'src/modules/part_A/A.1.alignment.and.RSEM.count.Rmd', eval=FALSE}
```


<!-- Option B: Load preprocessed -->
```{r child = 'src/modules/part_A/A.1B.load.input.files.Rmd', eval=FALSE}
```

<!-- Option A: Setup biologic object for analysis -->
<!-- Incorporate dfDesign, dfRSEM, dfTPM, dfModel -->
```{r child = 'src/modules/part_A/A2.create.analysis.object.Rmd', eval=FALSE}
```

<!-- Option A: Setup biologic object for analysis -->
<!-- Incorporate dfDesign, dfRSEM, dfTPM, dfModel -->
```{r child = 'src/modules/part_A/A2.create.analysis.object.pipeline.Rmd', eval=TRUE}
```
