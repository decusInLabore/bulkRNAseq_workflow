...
pipelineList[["folder"]] <- "/camp/stp/babs/working/boeings/Projects/pachnisv/franze.progatzky/475A_EGC_miRNAseq_RN21203_hairpin/"
...
pipelineList[["project_id"]] <- "RN21203hairpin"

## The LIMS ID will be used to retrieve project information
pipelineList[["lims.id"]] <- "RN21203"

## This is the lab name ##
pipelineList[["labname"]] <- "Pachnis"
...
pipelineList[["project_name"]] <- "Characterization of enteric glia cells related experiments"
...
pipelineList[["experiment.type"]] <- "mi_rna_seq"
...
###############################################################################
## Display parameters                                                        ##
pipelineList[["count.table.headline"]] <- "Counts for all Samples"
pipelineList[["count.table.sidelabel"]] <- "Counts"
...
pipelineList[["primDataDB"]] <- "vpl_data"
...
pipelineList[["lab.categories.table"]] <- "vp_lab_categories"
