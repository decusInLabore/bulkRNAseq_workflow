...
```{r child = 'src/modules/part_A/A.1.create.pipeline.parameter.file.Rmd', eval=TRUE}
```
...
<!-- Essential 1: (output required later): Set Parameters and directories and create Obio object Chapter/Module -->
```{r child = 'src/modules/part_A/A.2.create.pipeline.analysis.object.Rmd', eval=TRUE}
```
