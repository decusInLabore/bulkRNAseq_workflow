...
## Set folder
pipelineList[["folder"]] <- "/camp/stp/babs/working/boeings/Projects/pachnisv/franze.progatzky/209_vpl_fp_RNAseq_inflammatory_enteric_glia_cell_characterization/"
...
## Project parameters
pipelineList[["project_id"]] <- "vpl209"
pipelineList[["lims.id"]] <- "vpl209"
...
baseDesignFN <- "/camp/stp/babs/working/boeings/Projects/pachnisv/franze.progatzky/209_vpl_fp_RNAseq_inflammatory_enteric_glia_cell_characterization/workdir/bulkRNAseq_workflow/design/design.file.txt"
...
pipelineList[["designFN"]] <- paste0(pipelineList[["folder"]], "workdir/bulkRNAseq_workflow/design/", projectID,".design.table.txt")
...
pipelineList[["modelFN"]] <- paste0(pipelineList[["folder"]], "/workdir/bulkRNAseq_workflow/design/", projectID,".model.table.txt")
...
dfRefTab <- pipelineList[["ReferenceTable"]]
...
```{r child = 'src/modules/part_A/A.2.create.analysis.object.pipeline.Rmd', eval=FALSE}
```
